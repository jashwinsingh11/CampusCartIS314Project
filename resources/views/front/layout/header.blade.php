                ...
                <div class="col-lg-3 col-md-9 col-sm-6">
                    <div class="brand-logo text-lg-center">
                        ...
                        <a href="{{ url('/') }}">
                            ...
                            <img style='width:120px;' src="{{ asset('front/images/main-logo/logo.jpeg') }}" alt="Multi-vendor E-commerce Application" class="app-brand-logo">
                        </a>
                    </div>
                </div>
