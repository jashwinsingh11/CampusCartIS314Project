                                ...
                                <form name="checkoutForm" id="checkoutForm" action="{{ url('/checkout') }}" method="post">
                                    ...
                                    <div class="order-table">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($getCartItems as $item) {{-- $getCartItems is passed in from cart() method in Front/ProductsController.php --}}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h6 class="order-h6">FJD{{ $getDiscountAttributePrice['final_price'] * $item['quantity'] }}</h6> {{-- price of all products (after discount (if any)) (= price (after discoutn) * no. of products) --}}
                                                        </td>
                                                    </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h3 class="order-h3">FJD{{ $total_price }}</h3>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <h6 class="order-h6">
                                                            <span class="shipping_charges">FJD</span>
                                                        </h6>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div class="u-s-m-b-13 prepaidMethod"> {{-- We added the prepaidMethod CSS class to disable that payment method (check front/js/custom.js) if the PIN code of that user's Delivery Address doesn't exist in our `prepaid_pincodes` database table --}}
                                            ...
                                            <label class="label-text" for="iyzipay">M-Paisa Or MyCash</label>
                                        </div>
