    						...
    						<tbody>
                                ...
                                @foreach ($orderDetails['orders_products'] as $product)
                                    <tr>
                                        ...
                                        <td class="text-center">FJD {{ $product['product_price'] }}</td>
                                        <td class="text-center">{{ $product['product_qty'] }}</td>
                                        <td class="text-right">FJD {{ $product['product_price'] * $product['product_qty'] }}</td>
                                    </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="thick-line text-right">FJD {{ $subTotal }}</td>
                                </tr>
                                <tr>
                                    <td class="no-line"></td>
                                    <td class="no-line"></td>
                                    ...
                                    <td class="no-line text-right">FJD 0</td>
                                </tr>
                                <tr>
                                    <td class="no-line"></td>
                                    <td class="no-line"></td>
                                    ...
                                    <td class="no-line text-right">
                                        <strong>FJD {{ $orderDetails['grand_total'] }}</strong>
                                        <br>
